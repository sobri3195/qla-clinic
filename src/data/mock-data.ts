...
export const initialData: AppState = {
  ...
  treatments: [
    { id: 'tr-1', name: 'Signature Hydra Facial', category: 'facial', price: 850000, duration: 60, type: 'Therapist', popularity: 92, concernTags: ['Hydration boost', 'Glow instant', 'Pore refining'], downtimeDays: 0, resultWindow: 'Instant glow 3-5 hari', consumables: [{ productId: 'prd-1', qty: 1 }, { productId: 'prd-5', qty: 1 }] },
    { id: 'tr-2', name: 'Glow Peeling Therapy', category: 'peeling', price: 650000, duration: 45, type: 'Doctor', popularity: 80, concernTags: ['Brightening', 'Texture smoothing', 'Comedone control'], downtimeDays: 2, resultWindow: 'Kulit lebih halus 5-7 hari', consumables: [{ productId: 'prd-1', qty: 1 }] },
    { id: 'tr-3', name: 'Microdermabrasion Pro', category: 'mikrodermabrasi', price: 780000, duration: 50, type: 'Therapist', popularity: 76, concernTags: ['Texture refining', 'Sebum control'], downtimeDays: 1, resultWindow: 'Tekstur membaik dalam 3 hari', consumables: [{ productId: 'prd-4', qty: 1 }] },
    { id: 'tr-4', name: 'Laser Rejuvenation', category: 'laser', price: 1850000, duration: 75, type: 'Doctor', popularity: 88, concernTags: ['Anti-aging', 'Pigment correction', 'Firming'], downtimeDays: 3, resultWindow: 'Kolagen terpicu 2-4 minggu', consumables: [{ productId: 'prd-5', qty: 1 }] },
    { id: 'tr-5', name: 'Botox Sculpting', category: 'botox', price: 3250000, duration: 40, type: 'Doctor', popularity: 84, concernTags: ['Fine lines', 'Jaw slimming', 'Preventive aging'], downtimeDays: 1, resultWindow: 'Hasil optimal 7-14 hari', consumables: [{ productId: 'prd-4', qty: 1 }] },
    { id: 'tr-6', name: 'Filler Contour Deluxe', category: 'filler', price: 4500000, duration: 50, type: 'Doctor', popularity: 67, concernTags: ['Facial contour', 'Volume restore'], downtimeDays: 4, resultWindow: 'Contour settle 10-14 hari', consumables: [{ productId: 'prd-4', qty: 1 }] },
    { id: 'tr-7', name: 'PRP Skin Revival', category: 'PRP', price: 2750000, duration: 70, type: 'Hybrid', popularity: 71, concernTags: ['Scar recovery', 'Skin regeneration'], downtimeDays: 3, resultWindow: 'Regenerasi terlihat 2-3 minggu', consumables: [{ productId: 'prd-5', qty: 1 }] },
    { id: 'tr-8', name: 'Microneedling Glass Skin', category: 'microneedling', price: 2100000, duration: 80, type: 'Hybrid', popularity: 90, concernTags: ['Acne scars', 'Glass skin', 'Pore minimising'], downtimeDays: 3, resultWindow: 'Kulit lebih rata 7-10 hari', consumables: [{ productId: 'prd-4', qty: 1 }, { productId: 'prd-5', qty: 1 }] },
    { id: 'tr-9', name: 'Infus Whitening Luxe', category: 'infus whitening', price: 950000, duration: 55, type: 'Therapist', popularity: 65, concernTags: ['Radiance support', 'Event prep'], downtimeDays: 0, resultWindow: 'Kulit tampak fresh 1-3 hari', consumables: [{ productId: 'prd-1', qty: 1 }] },
    { id: 'tr-10', name: 'Slimming Body Sculpt', category: 'slimming treatment', price: 1500000, duration: 60, type: 'Therapist', popularity: 58, concernTags: ['Body contour', 'Firming support'], downtimeDays: 0, resultWindow: 'Maintenance mingguan direkomendasikan', consumables: [{ productId: 'prd-5', qty: 1 }] },
    { id: 'tr-11', name: 'Acne Reset Program', category: 'acne treatment', price: 720000, duration: 50, type: 'Doctor', popularity: 87, concernTags: ['Active acne', 'Barrier recovery', 'Calming'], downtimeDays: 1, resultWindow: 'Inflamasi turun 3-7 hari', consumables: [{ productId: 'prd-2', qty: 1 }, { productId: 'prd-5', qty: 1 }] },
    { id: 'tr-12', name: 'Brightening Infusion', category: 'brightening treatment', price: 1180000, duration: 65, type: 'Hybrid', popularity: 82, concernTags: ['Hyperpigmentation', 'Tone evening', 'Glow maintenance'], downtimeDays: 1, resultWindow: 'Tone lebih merata dalam 5-7 hari', consumables: [{ productId: 'prd-3', qty: 1 }, { productId: 'prd-5', qty: 1 }] },
  ],
  treatmentPackages: [
    {
      id: 'pkg-1',
  ...
  products: [
    { id: 'prd-1', name: 'QLA Gentle Cleanser', category: 'Cleanser', regimenStep: 'Step 1 · Cleanse', heroIngredient: 'Amino acid surfactant', price: 185000, stock: 42, minStock: 15, supplier: 'Dermalab Supplies', recommendationFor: 'Sensitive skin', status: 'Ready' },
    { id: 'prd-2', name: 'QLA Acne Defense Serum', category: 'Serum', regimenStep: 'Step 2 · Treat', heroIngredient: 'Niacinamide + zinc PCA', price: 325000, stock: 18, minStock: 12, supplier: 'Dermalab Supplies', recommendationFor: 'Acne prone', status: 'Ready' },
    { id: 'prd-3', name: 'QLA Brightening Essence', category: 'Essence', regimenStep: 'Step 2 · Treat', heroIngredient: 'Tranexamic acid', price: 410000, stock: 10, minStock: 12, supplier: 'Glow Source Asia', recommendationFor: 'Dull skin', status: 'Low Stock' },
    { id: 'prd-4', name: 'QLA Barrier Repair Moisturizer', category: 'Moisturizer', regimenStep: 'Step 3 · Repair', heroIngredient: 'Ceramide complex', price: 295000, stock: 24, minStock: 10, supplier: 'Glow Source Asia', recommendationFor: 'Dry & compromised skin', status: 'Ready' },
    { id: 'prd-5', name: 'QLA UV Shield SPF50', category: 'Sunscreen', regimenStep: 'Step 4 · Protect', heroIngredient: 'Broad spectrum UV filter', price: 265000, stock: 30, minStock: 10, supplier: 'QLA Warehouse', recommendationFor: 'Post-treatment', status: 'Ready' },
  ],
  patients: [
    {
      id: 'pt-1', medicalRecordNumber: 'MR-240301', name: 'Nabila Amara', age: 27, phone: '0812-1111-2222', email: 'nabila@qla-demo.com', gender: 'Female', concern: 'Acne scars & uneven texture', skinType: 'Combination Acne-Prone', allergies: ['AHA tinggi'], memberTier: 'Gold', loyaltyPoints: 420, referralCode: 'NABILA420', status: 'VIP', joinedAt: '2025-09-12', lastVisit: format(today, 'yyyy-MM-dd'), notes: 'Prefer afternoon sessions. Comfortable with microneedling + LED.', beautyGoals: ['Bekas jerawat memudar', 'Tekstur lebih halus', 'Makeup lebih menempel'], avoidedIngredients: ['AHA tinggi', 'Physical scrub'], preferredTreatmentIntensity: 'Moderate', routineCompliance: 86, selfieReminderOptIn: true, beforeAfter: [{ visitDate: format(addDays(today, -49), 'yyyy-MM-dd'), sessionLabel: 'Session 1', area: 'Cheek & forehead', before: 'https://placehold.co/600x400/f9e3e8/6f4d57?text=Before+Week+1', after: 'https://placehold.co/600x400/e9f6f1/3f8f6b?text=After+Week+8', progressNotes: 'Erythema turun signifikan, tekstur membaik.', consentUsage: true }], treatmentHistory: ['Microneedling Glass Skin', 'Acne Reset Program', 'LED calming therapy'], purchaseHistory: ['QLA Acne Defense Serum', 'QLA UV Shield SPF50']
    },
    {
      id: 'pt-2', medicalRecordNumber: 'MR-240302', name: 'Catherine Wijaya', age: 34, phone: '0813-3333-4444', email: 'catherine@qla-demo.com', gender: 'Female', concern: 'Fine lines & skin dullness', skinType: 'Dry Mature', allergies: ['Fragrance'], memberTier: 'Platinum', loyaltyPoints: 890, referralCode: 'CATH890', status: 'Follow Up', joinedAt: '2024-12-20', lastVisit: format(addDays(today, -3), 'yyyy-MM-dd'), notes: 'Interested in anti-aging package and homecare recommendations.', beautyGoals: ['Garis halus lebih tersamarkan', 'Contour rahang tegas', 'Kulit tetap glowing'], avoidedIngredients: ['Fragrance', 'Alcohol tinggi'], preferredTreatmentIntensity: 'Intensive', routineCompliance: 93, selfieReminderOptIn: true, beforeAfter: [{ visitDate: format(addDays(today, -30), 'yyyy-MM-dd'), sessionLabel: 'Contour review', area: 'Jawline & smile lines', before: 'https://placehold.co/600x400/f6ebe6/7d5c61?text=Before+Contour', after: 'https://placehold.co/600x400/f5f7ec/53735f?text=After+Contour', progressNotes: 'Contour lebih tegas, skin glow meningkat.', consentUsage: true }], treatmentHistory: ['Botox Sculpting', 'Laser Rejuvenation'], purchaseHistory: ['QLA Brightening Essence', 'QLA Barrier Repair Moisturizer']
    },
    {
      id: 'pt-3', medicalRecordNumber: 'MR-240303', name: 'Michelle Santoso', age: 29, phone: '0812-5555-8888', email: 'michelle@qla-demo.com', gender: 'Female', concern: 'Hyperpigmentation & glow maintenance', skinType: 'Normal', allergies: ['None'], memberTier: 'Silver', loyaltyPoints: 190, referralCode: 'MICH190', referredBy: 'NABILA420', status: 'Active', joinedAt: '2025-05-03', lastVisit: format(addDays(today, -12), 'yyyy-MM-dd'), notes: 'Often books weekend appointments with therapist Mey.', beautyGoals: ['Tone kulit merata', 'Glow stabil untuk event', 'Perawatan minim downtime'], avoidedIngredients: ['None'], preferredTreatmentIntensity: 'Gentle', routineCompliance: 78, selfieReminderOptIn: false, beforeAfter: [{ visitDate: format(addDays(today, -21), 'yyyy-MM-dd'), sessionLabel: 'Brightening review', area: 'Cheeks', before: 'https://placehold.co/600x400/f7e9e8/7a5b67?text=Before+Pigment', after: 'https://placehold.co/600x400/ecf7f2/507562?text=After+Brightening', progressNotes: 'Pigment ringan tersamarkan, tone lebih merata.', consentUsage: false }], treatmentHistory: ['Brightening Infusion', 'Signature Hydra Facial'], purchaseHistory: ['QLA Gentle Cleanser', 'QLA UV Shield SPF50']
    }
  ],
  appointments: [
